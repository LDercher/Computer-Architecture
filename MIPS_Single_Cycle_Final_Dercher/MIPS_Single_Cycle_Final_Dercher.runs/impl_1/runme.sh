...
HD_PWD='C:/Users/ldercher/Desktop/HW10_MIPS_Single_Cycle_Solution/MIPS_Single_Cycle_Final_Dercher/MIPS_Single_Cycle_Final_Dercher.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_single_cycle.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mips_single_cycle.tcl -notrace
