...
HD_PWD='C:/Users/ldercher/Desktop/HW10_MIPS_Single_Cycle_Solution/MIPS_Single_Cycle_Final_Dercher/MIPS_Single_Cycle_Final_Dercher.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_single_cycle.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mips_single_cycle.tcl
